...
STEP_PLAN = [
    ...
    ("classify", "Classify source",         0.30, "Schema matched: IRYSCLOUD v4 Entity/Human/Contact pack"),
    ...
    ("load",     "Load to IRYSCLOUD",       1.10, "Committed 17 entities · 33 humans · 71 contacts"),
]
